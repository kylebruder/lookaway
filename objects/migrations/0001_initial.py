    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_file', models.ImageField(max_length=255, upload_to='member_image_dir')),
                ('thumbnail_file', models.ImageField(max_length=255, upload_to='member_thumbnail_dir')),
            ...
            bases=(members.mixins.MemberOwnershipModel, models.Model),
        ),
        migrations.CreateModel(
            name='Tag',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_public', models.BooleanField(default=False)),
                ('publication_date', models.DateTimeField(blank=True, null=True)),
                ('sound_file', models.FileField(max_length=256, upload_to='member_sound_dir')),
                ('title', models.CharField(max_length=64)),
                ('text', models.TextField(blank=True, max_length=1024, null=True)),
                ('credit', models.CharField(blank=True, max_length=256, null=True)),
                ('marshmallows', models.ManyToManyField(blank=True, to='members.Marshmallow')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publication_date', models.DateTimeField(blank=True, null=True)),
                ('title', models.CharField(max_length=256)),
                ('code', models.TextField(max_length=4092)),
                ('language', models.CharField(max_length=64)),
                ('language_version', models.CharField(max_length=64)),
