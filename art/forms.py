...
the title of this section to be displayed on the page.""",
    ...
    class Meta:
        ...
        help_texts = {
            ...
            'galleries': """Choose one or more galleries to feature in this section.""",
...
class GalleryForm(forms.ModelForm):
    ...
    visuals = CustomModelMultipleChoiceField(
        queryset=Image.objects.all(),
        help_text="""Choose which Visuals you would like to include in the Gallery.""",
    )
    title = forms.CharField(
...
The optimal format is 'Primary Keyword - Secondary Keyword | Brand Name'.""",
    ...
    artist = forms.CharField(
        help_text="""Which artist or artists produced the Visuals included in the Gallery?""",
        max_length=128,
    )
    meta_description = forms.CharField(
        widget=forms.Textarea(
...
Keep it less than 155 characters.""",
    ...
    text = forms.CharField(
        ...
        help_text="""Provide some information and context about the Gallery. (optional)""",
        max_length=65535,
        required=False
    )
    title.widget.attrs.update({'class': 'form-text-field'})
...
Example: art collective website/gallery website/purchase options. (optional)""",
...
The optimal format is 'Primary Keyword - Secondary Keyword | Brand Name'.""",
    ...
    order = forms.DecimalField(
        help_text="""Choose the order in which the Visual will appear in Galleries.
...
Keep it less than 155 characters.""",
    ...
    text = forms.CharField(
        ...
        help_text="""Provide some information and context about the Visual. (optional)""",
        max_length=65535,
        required=False
    )
...
Example: Oil on Canvas, 35mm film, India ink on paper. (optional)""",
    ...
    dimensions = forms.CharField(
        help_text="""Provide measurements such as length, width, diameter or weight.""",
        max_length=1028,
        required=False
    )
