...
from .models import DocumentationAppProfile
# Model by tag mixin

class NewModelListMixin:
    '''
    Queryset and context for new list views using DocumentationAppProfile.
    '''
...
class TopModelListMixin:
    '''
    Queryset and context for top list views using DocumentationAppProfile.
    '''
    def get_queryset(self, *args, **kwargs):
        context = super().get_queryset(**kwargs)
        return self.model.objects.filter(
...
class StudioListMixin:
    ...
    Also sets the DocumentationAppProfile.
    '''
    def get_queryset(self, *args, **kwargs):
...
class ModelByMemberMixin:
    ...
    the view. Also sets the DocumentationAppProfile.
    '''
    def get_queryset(self, *args, **kwargs):
